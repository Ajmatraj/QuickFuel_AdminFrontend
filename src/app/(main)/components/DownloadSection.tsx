...
const DownloadSection = () => {
  return (
    <>
    <section id="download" className="w-full py-12 md:py-24 bg-green-600 text-white">
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative">
                ...
                <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-green-400 rounded-full animate-bounce opacity-70"></div>
              </div>
            </div>
          </div>
        </div>
