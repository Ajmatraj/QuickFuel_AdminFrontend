...
const UserNavbar = () => {
  ...
  useEffect(() => {
    // You can check local storage, cookies, or context
    const accessToken = localStorage.getItem("authToken") // Example, replace with actual check
    setIsLoggedIn(!!accessToken) // If token exists, user is logged in
  }, [])
